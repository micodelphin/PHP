...
$user_subscriber_counts = mysqli_num_rows($select_all_subscriber_user );                
...
$element_text = ['All post', 'active post' , 'draft', 'comments' , 'pending comments', 'users' ,'subscribers' , 'categories'];         
$element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts,$unapproved_comment_counts, $user_counts,$user_subscriber_counts , $category_counts];
